...
export default function FooterSection() {
    return (
        <footer className="py-16 md:py-28  border-t-1">
            <div className="mx-auto max-w-5xl px-6" >
                ...
                <span className="text-muted-foreground block text-center text-sm mt-5"> © {new Date().getFullYear()} Notely, All rights reserved</span>
            </div>
        </footer>
    )
}
