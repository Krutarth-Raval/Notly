            ...
            <div className="mx-auto max-w-5xl px-6">
              <div className="sm:mx-auto lg:mr-auto lg:mt-0">
                <TextEffect
                  ...
                  speedSegment={0.3}
                  as="h1"
                  className="mt-8 max-w-2xl text-pretty text-5xl font-medium md:text-6xl lg:mt-16"
                ...
                >
                  A fast, clean, and secure notes app to capture ideas, manage
                  tasks, and stay focused whether you’re on the go or at your
                  desk.
                </TextEffect>
